...
class ProductComment(models.Model):
    ...
    product = models.ForeignKey(Medicine, on_delete=models.CASCADE, related_name="comments")
...
class CommentLike(models.Model):
    ...
    comment = models.ForeignKey(ProductComment, on_delete=models.CASCADE, related_name="emoji_reactions")
...
class CommentAnalysis(models.Model):
    ...
    toxicity_score = models.FloatField(
        validators=[MinValueValidator(0), MaxValueValidator(1)], help_text="Average toxicity score for batch"
    )
