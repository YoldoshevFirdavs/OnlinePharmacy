...
from pharmacy.models.misc import Review, FlashSale, ProductViewHistory, MedicineImage
from pharmacy.permissons import IsVerifiedSeller
from pharmacy.serializers.misc import (
    MedicineListSerializer, MedicineDetailSerializer, CategorySerializer,
    ReviewSerializer, FlashSaleSerializer, ProductViewHistorySerializer,
