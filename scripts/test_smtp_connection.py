...
try:
    ...
    print("Iltimos, config/email_config.py faylini to'g'ri yaratganingizga ishonch hosil qiling.")
    sys.exit(1)
...
def test_smtp_connection():
    ...
    if not EMAIL_HOST_USER or not EMAIL_HOST_PASSWORD or EMAIL_HOST_USER == "your_gmail_address@gmail.com":
        print("\n!!! DIQQAT !!!")
        print("EMAIL_HOST_USER yoki EMAIL_HOST_PASSWORD config/email_config.py faylida to'g'ri konfiguratsiya qilinmagan.")
        print("Iltimos, 'your_gmail_address@gmail.com' va 'your_app_password' joyiga haqiqiy ma'lumotlarni kiriting.")
    ...
    try:
        if EMAIL_USE_TLS:
            ...
            with smtplib.SMTP(EMAIL_HOST, EMAIL_PORT) as server:
                ...
                server.sendmail(DEFAULT_FROM_EMAIL, EMAIL_HOST_USER, "Subject: SMTP Test\n\nThis is a test email from smtplib.")
        ...
        print("3. Gmail hisobingizda 2-bosqichli tekshirish (2-Step Verification) yoqilmagan.")
        print("4. App Password o'rniga asosiy Gmail paroli ishlatilgan.")
        print("Iltimos, Gmail App Password'ingizni qayta yaratib, config/email_config.py faylini yangilang.")
