...
class BanRecordTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.ban_perm = BanRecord.objects.create(
            ip="192.168.1.2", reason="Permanent ban for abuse", ban_type="permanent", created_by="admin", attempts=100
        )
...
class BanMiddlewareTestCase(TestCase):
    ...
    def test_permanent_ban_shown(self):
        ...
        BanRecord.objects.create(
            ip="127.0.0.1", reason="Permanent ban for abuse", ban_type="permanent", created_by="admin", attempts=100
        )
