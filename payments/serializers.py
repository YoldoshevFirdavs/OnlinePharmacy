...
class PayoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payout
        fields = ['id', 'amount_gross', 'net_amount', 'currency', 'status', 'driver_full_name', 'created_at']
        read_only_fields = ['id', 'amount_gross', 'net_amount', 'currency', 'status', 'driver_full_name', 'created_at']
