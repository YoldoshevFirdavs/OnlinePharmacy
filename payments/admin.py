...
class PayoutAdmin(admin.ModelAdmin):
    list_display = ('driver', 'amount_gross', 'tax_amount', 'net_amount', 'status', 'created_at')
    list_filter = ('status', 'created_at', 'driver')
    search_fields = ('driver__user__full_name', 'driver__user__phone_number', 'stripe_transfer_id')
